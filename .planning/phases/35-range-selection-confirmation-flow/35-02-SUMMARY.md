...
Completed the two-tap calendar booking flow and bottom confirmation sheet for Phase 35.
...
- Phase 36 still needs to improve reservation visibility, add stable resource colors, and remove reliance on the old standalone calendar entry point.
