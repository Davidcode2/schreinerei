...
key-decisions:
  - "Kept /attachments/photo response contract for the Phase 30 camera flow while adding a new generic /attachments endpoint for document uploads."
...
# Phase 31 Plan 01: Document Upload Rework Summary
...
## Decisions Made
- Preserved the legacy photo upload route and response so Phase 30 camera UX keeps working while new document uploads move to `/api/v1/sites/{id}/attachments`.
