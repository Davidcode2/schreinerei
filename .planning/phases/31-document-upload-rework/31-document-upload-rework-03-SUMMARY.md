...
# Phase 31 Plan 03: Document Upload Rework Summary
...
- Treated PDF entries as explicit document cards rather than fake image previews to match the approved Phase 31 contract.
...
- Phase 32 can layer fullscreen media viewing on top of the attachment grid without changing the feed data contract.
