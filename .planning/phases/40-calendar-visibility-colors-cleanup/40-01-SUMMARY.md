...
key-decisions:
  ...
  - "Applied resource color as row and chip accents while keeping status-based reservation fills and Phase 39 selection flow unchanged."
...
# Phase 40 Plan 01: Calendar Visibility and Color Summary
...
- Phase 39 two-tap selection and confirmation sheet behavior remains intact.
