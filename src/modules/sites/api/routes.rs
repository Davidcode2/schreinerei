...
impl From<crate::modules::sites::domain::Site> for SiteResponse {
    fn from(site: crate::modules::sites::domain::Site) -> Self {
        Self {
            ...
            invoice_pricing_mode: site.invoice_pricing_mode.map(|mode| mode.to_string()),
    ...
    for ProjectMaterialUsageLineResponse
{
    fn from(
        ...
        Self {
            ...
            price_markup_percentage: line.price_markup_percentage,
...
pub async fn create_site(
    ...
    let create = CreateSite {
        ...
        invoice_pricing_mode: request
            .invoice_pricing_mode
            .map(|value| value.parse())
            .transpose()
            .map_err(|e: String| AppError::Validation(e))?,
        hourly_rate_cents: request.hourly_rate_cents,
        fixed_price_cents: request.fixed_price_cents,
...
pub async fn update_site(
    ...
    let update = UpdateSite {
        ...
        clear_invoice_pricing_mode: request.clear_invoice_pricing_mode.unwrap_or(false),
        clear_hourly_rate_cents: request.clear_hourly_rate_cents.unwrap_or(false),
        clear_fixed_price_cents: request.clear_fixed_price_cents.unwrap_or(false),
